package com.example.laptor.rxcoaster;
...
import com.example.laptor.rxcoaster.debugActivities.InteractActivity;
import com.example.laptor.rxcoaster.utils.RxBleClientSingleton;
...
public class MainActivity extends AppCompatActivity {
    ...
    //After reading characteristic data
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_ENABLE_BT && resultCode == Activity.RESULT_CANCELED) {
            Toast.makeText(this, "You must turn Bluetooth on, to use thist app", Toast.LENGTH_LONG).show();
            finish();
            return;
        }
    ...
    private void startLeScan() {
        ...
        UUID tempServiceUUID = UUID.fromString("f000ba55-0451-4000-b000-000000000000");
        filters.add(new ScanFilter.Builder().setServiceUuid(new ParcelUuid(tempServiceUUID)).build());
